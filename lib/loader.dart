...
class FlaskPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final topRRect = RRect.fromRectAndRadius(topRect, Radius.circular((10.0)));
...
class WavePainter extends CustomPainter{
  static const int kWaveLength = KWaveLength;
  AnimationController animationController;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for(int i=-xOffset.toInt();i<=xOffset;i++){
      polygonOffsets.add(Offset(
        i.toDouble(),
        isRightDirection ?
        math.sin(vector.radians(i.toDouble()*360/kWaveLength) - vector.radians(animationController.value))*20 -25
            : math.sin(vector.radians(i.toDouble()*360/kWaveLength) + vector.radians(animationController.value))*20 -20
      ));
    }
